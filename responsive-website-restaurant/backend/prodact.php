<div class="container w-100 h-100 overflow-auto">
    ...
    <button type="button" class="btn btn-primary d-flex justify-content-start mb-2"
        onclick="$('#modal').load('./backend/add_form.php?do=Home')">新增圖片</button>
    <div id="modal"></div>
...
<div id="modal"></div> -->
            ...
            foreach ($rows as $row) {
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        ...
                        <input type="text" name="text1[]" value="<?= $row['text1']; ?>" class="form-control" id="textInput1"
                            placeholder="內容(1)">
                        <label for="textInput2" class="form-label">文字內容(2)</label>
                        <input type="text" name="text2[]" value="<?= $row['text2']; ?>" class="form-control" id="textInput2"
                            placeholder="內容(1)">
                    </td>
    ...
    `;
        ...
        function editRow(rowData) {
            ...
            const url = './backend/add_form.php?do=Home&' + params;
            $('#modal').load(url);
