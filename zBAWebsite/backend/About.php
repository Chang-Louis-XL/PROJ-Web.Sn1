            ...
            <tbody>
                ...
                foreach ($rows as $row) {
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <label for="textInput1" class="form-label">title內容</label>
                            <input type="text" name="text1[]" value="<?= $row['text1']; ?>" class="form-control"
                                id="textInput1" placeholder="內容">
                            <label for="textInput1" class="form-label">文字內容</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class='form-group mx-auto col-6 mt-5' action="./api/add.php" method="post"
                    ...
                    <div class='d-flex my-2'>
                        <label for="" class='col-3 form-label'>title內容</label>
                        <input type="text" name="text1">
                    </div>
                    <div class='d-flex my-2'>
                        <label for="" class='col-3 form-label'>文字內容</label>
